...
int inv_serial_write_fifo(
	...
	unsigned short length,
	unsigned char const *data);
#ifdef CONFIG_SENSOR_I2C_ABNORMAL_STATUS_REPORT
/*
*   I2C_STATUS
*   add by liwei,for abnormal status detect
*/
enum {
	I2C_NORAML_STATUS = 0,
	I2C_ABNORAML_STATUS
...
/*
*    Init i2c status report info
*/
int inv_mpu_i2c_status_report_init(void);
int inv_mpu_clear_report_info(void);
int inv_mpu_report_abnormal_info(void);
#endif
/**
 * @}
 */
