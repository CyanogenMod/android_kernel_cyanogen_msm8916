...
static DEVICE_ATTR(reg, S_IWUGO | S_IRUGO,
...
static DEVICE_ATTR(ps_calibration, S_IWUGO | S_IRUGO,
...
#if 1  //chenyunzhe remove this codes below for no need to force PS report system  status becase of MISC_SCAN 
