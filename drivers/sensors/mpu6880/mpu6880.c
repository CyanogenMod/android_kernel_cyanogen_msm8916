...
#define MPU6880_CAPTURE_TIMES			10
...
static void mpu6880_accel_gyro_calibration(struct mpu6880_device *dev)
{
	int i = 0;
	int err = 0;
	...
	dev->gyro_offset[0] = sum_gyro[0]/MPU6880_CAPTURE_TIMES;
	dev->gyro_offset[1] = sum_gyro[1]/MPU6880_CAPTURE_TIMES;
	dev->gyro_offset[2] = sum_gyro[2]/MPU6880_CAPTURE_TIMES;
...
static DEVICE_ATTR(accel_enable,  S_IWUGO | S_IRUGO, mpu6880_accel_enable_show,  mpu6880_accel_enable_store);
static DEVICE_ATTR(accel_delay,  S_IWUGO | S_IRUGO, mpu6880_accel_delay_show,  mpu6880_accel_delay_store);
static DEVICE_ATTR(gyro_enable,  S_IWUGO | S_IRUGO, mpu6880_gyro_enable_show,  mpu6880_gyro_enable_store);
static DEVICE_ATTR(gyro_delay,  S_IWUGO | S_IRUGO, mpu6880_gyro_delay_show,  mpu6880_gyro_delay_store);
static DEVICE_ATTR(device_delay,  S_IWUGO | S_IRUGO, mpu6880_device_delay_show,  mpu6880_device_delay_store);
static DEVICE_ATTR(calibration,  S_IWUGO | S_IRUGO, mpu6880_calibration_show,  mpu6880_calibration_store);
static DEVICE_ATTR(debug,  S_IWUGO | S_IRUGO, mpu6880_debug_show,  mpu6880_debug_store);
...
static int mpu6880_device_init(struct i2c_client *client)
{
	...
	res = mpu6880_write(client, MPU6880_ACCEL_CONFIG2,0x00);
	if (res) 
	{
		printk("MPU6880 Configure Accel error,res: %d!\n", res);
		return res;
	}
