...
#define AL3320_DEVICE_NAME                ALSPROX_DRIVER_NAME
#define AL3320_INPUT_NAME_L               "al3320_light"
#define AL3320_DRV_NAME	"al3320"
#define DRIVER_VERSION		"1.04"

#define AL3320_IOCTL_ALS_ON               ALSPROX_IOCTL_ALS_ON
#define AL3320_IOCTL_ALS_OFF              ALSPROX_IOCTL_ALS_OFF
...
u16 als_poll_delay = 500;			/* Set polling delay (ms) for polling mode */
