...
struct ext_slave_descr {
	...
	int (*get_config) (void *mlsl_handle,
			   ...
			   struct ext_slave_config *config);
			   /*
        int (*gsensor_calibration) (void *accel_handle,
                                   struct ext_slave_descr *slave,
	                           struct ext_slave_platform_data *pdata,
                                   struct gsensor_offset *tmpCalData);
        int (*gsensor_setOffset) (void *accel_handle,
                                   struct ext_slave_descr *slave,
	                           struct ext_slave_platform_data *pdata,
                                   struct gsensor_offset *tmpCalData);
			   */
...
/*
*struct gsensor_offset- calibration data for gsensor
*add by liwei,20120228
*/
struct gsensor_offset{
    unsigned short key;
    short x;
    short y;
    short z;
...
/*
#define MPU_GSENSOR_CALIBRATION _IOWR(MPU_IOCTL, 0x23, unsigned long)
#define MPU_GSENSOR_SET_OFFSET _IOWR(MPU_IOCTL, 0x24, unsigned long)
*/
...
/* accel bias*/
#define MPU_SET_ACCEL_BIAS _IOW(MPU_IOCTL,0x46,short int [3])
#define MPU_GET_ACCEL_BIAS _IOR(MPU_IOCTL,0x47,short int [3])

/* get calibration status */
#define MPU_GET_CAL_STATUS _IOR(MPU_IOCTL, 0x48, __u32)
